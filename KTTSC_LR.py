...
import numpy as np
#### Load source data
s_data = pd.read_csv("F:\\oodata_python\\AEEEM\\Lucene.csv")
s_input = s_data.loc[:,'ck_oo_numberOfPrivateMethods':'LDHH_numberOfMethods']

#s_data = pd.read_csv("F:\\HDP\\data\\NASA\\mw1.csv")
#s_input = s_data.loc[:,'LOC_BLANK numeric':'LOC_TOTAL numeric']
...
logreg = LogisticRegression(random_state=0, solver='newton-cg', multi_class='ovr')
