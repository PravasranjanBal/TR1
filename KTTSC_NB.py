...
#s_data = pd.read_csv("F:\\oodata_python\\JIRA\\groovy.csv")
#s_input = s_data.loc[:,'CountDeclMethodPrivate':'MAJOR_LINE']
...
#t_data = pd.read_csv("F:\\oodata_python\\JIRA\\jruby.csv")
#t_input = t_data.loc[:,'CountDeclMethodPrivate':'MAJOR_LINE']
...
noise = np.random.normal(mu, sigma, [l,65]) 
#print(noise)
